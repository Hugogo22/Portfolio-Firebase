<template>
  <div class="min-h-screen bg-center bg-cover bg-space flex items-center justify-center">
    <div class="text-white font-mono text-lg font-bold w-3/5 text-justify p-10 border-2 border-white rounded-md bg-black bg-opacity-30">
      <p>
      ...
      <p>
        I will meet a systems engineer working in the space industry in November to learn more about the different career paths I can chose.
      </p>
    </div>
  </div>
</template>
